...
namespace StoreHub.Web
{
    public class Program
    {
        ...
        private static void ConfigureLogging(WebApplicationBuilder builder)
        {
            ...
            var sumoUrl = Environment.GetEnvironmentVariable("STOREHUB_SUMOLOGIC_URL");
            ...
            sumoTarget.Url = Environment.GetEnvironmentVariable("STOREHUB_SUMOLOGIC_URL");
            sumoTarget.SourceName = $"StoreHub.{Environment.GetEnvironmentVariable("STOREHUB_ENVIRONMENT")}";
            sumoTarget.SourceCategory = "storehub";
        ...
        {
            var clientIdentifier = Environment.GetEnvironmentVariable("STOREHUB_OPEN_FEATURE_CLIENT_ID");
            ...
            {
                await OpenFeature.Api.Instance.SetProviderAsync(new OctopusFeatureProvider(new OctopusFeatureConfiguration(clientIdentifier, new ProductMetadata("StoreHub"))));
            }
        }
        ...
        public static IStoreHubDataAdapter GetDataAdapter()
        {
            return new StoreHubDataAdapter(GetMetricConfiguration());
        }
    }
}
