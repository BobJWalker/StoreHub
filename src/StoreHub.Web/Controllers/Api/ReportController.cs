...
namespace StoreHub.Web.Controllers.Api
{
    ...
    public class ReportController(IStoreHubDataAdapter storeHubDataAdapter) : ControllerBase
    {
        [HttpPost]
        ...
        public async Task<ReportResponseViewModel> GetDeploymentCounts(ReportRequestViewModel request)
        {
            ...
            {
                Data = await storeHubDataAdapter.QueryAsync<ReportResponseDataViewModel>(
