...
namespace StoreHub.Web.DataAccess
{
    public interface IStoreHubDataAdapter
    {
    ...
    public class StoreHubDataAdapter(IMetricConfiguration metricConfiguration) : IStoreHubDataAdapter
    {
