...
namespace StoreHub.Database.DbUp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var executingPath = Assembly.GetExecutingAssembly().Location.Replace("StoreHub.Database.DbUp.dll", "").Replace("StoreHub.Database.DbUp.exe", "");
